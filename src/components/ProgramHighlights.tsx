...
const programHighlights: ProgramHighlight[] = [
  { id: 'skills', title: 'Skill Development Programs', description: 'Comprehensive training in sewing, beauty services, computer skills, and traditional crafts', icon: '📘', impact: '500+ women trained across multiple skills', color: 'text-blue-600', bgColor: 'bg-blue-50' },
  { id: 'awareness', title: 'Social Awareness Campaigns', description: "Legal literacy, drug awareness, and women's rights education programs", icon: '🛡️', impact: 'Community-wide impact across multiple districts', color: 'text-green-600', bgColor: 'bg-green-50' },
  { id: 'handicrafts', title: 'Traditional Handicrafts', description: 'Preserving traditional arts while creating modern market opportunities', icon: '🎨', impact: 'Market access for 100+ artisans', color: 'text-purple-600', bgColor: 'bg-purple-50' },
  { id: 'empowerment', title: "Women's Empowerment", description: 'Economic independence through entrepreneurship and skill building', icon: '❤️', impact: '200+ women entrepreneurs created', color: 'text-pink-600', bgColor: 'bg-pink-50' },
  { id: 'environment', title: 'Environmental Initiatives', description: 'Water conservation, sanitation, and clean city campaigns', icon: '💧', impact: 'Improved sanitation for thousands', color: 'text-teal-600', bgColor: 'bg-teal-50' },
  { id: 'recognition', title: 'ISO Certified Organization', description: 'ISO 9001:2015 certified for quality management systems', icon: '🏆', impact: 'Recognized for excellence in service delivery', color: 'text-amber-600', bgColor: 'bg-amber-50' }
];
  ...
  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programHighlights.map((highlight) => (
            <div key={highlight.id} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className={`${highlight.bgColor} ${highlight.color} w-12 h-12 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                <span className="text-xl" aria-hidden>{highlight.icon}</span>
              </div>
