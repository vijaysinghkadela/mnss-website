      ...
      <Container>
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Measurable outcomes that reflect our commitment to community
            transformation and sustainable social development across Rajasthan.
          </p>
        </motion.div>
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 mb-6">
          <div
            className={`w-16 h-16 bg-gradient-to-br ${stat.color} rounded-full flex items-center justify-center text-white mx-auto transform group-hover:scale-110 transition-all duration-300 shadow-lg`}
          >
