    ...
    programs: [
      {
        ...
        description:
          "Skill development for marginalized communities in craft and embroidery work, partnered with National Institute of Fashion Technology",
        beneficiaries: 40,
      ...
      },
      {
        ...
        description:
          "Awareness programs to combat drug addiction and its social impact",
      ...
      },
      {
        ...
        description:
          "Skill development program for women to establish self-employment",
        beneficiaries: 180,
        outcome:
          "155 trainees achieved self-employment earning 7000-8000 per month",
      },
      {
        ...
        outcome:
          "Increased awareness about women's rights and legal protections",
      },
      {
        name: "Girl Child Protection Campaign",
        description:
          "Programs to prevent female infanticide and promote girl education",
        beneficiaries: "Community wide",
    ...
    programs: [
      {
        ...
        description:
          "Training in home-based food processing, handicrafts and soft toys manufacturing",
        beneficiaries: 40,
      ...
      },
      {
        ...
        description:
          "Basic computer skills and mobile repair training under livelihood mission",
        beneficiaries: 180,
      ...
      },
      {
        name: "Drug Awareness Campaign",
        description:
          "Community programs against drug addiction in Ramsia village",
      ...
      },
      {
        name: "Sewing & Cutting Training",
        description:
          "Advanced tailoring skills with market-oriented fashion training",
        beneficiaries: 160,
      ...
      },
      {
        ...
        description:
          "Campaigns against female infanticide with government scheme awareness",
        beneficiaries: "Community wide",
      ...
      },
      {
        ...
        description:
          "Awareness about sewerage connections and clean water systems",
      ...
      },
      {
        name: "Beauty Parlour Training",
        description:
          "Professional beauty services training for economic empowerment",
        beneficiaries: 50,
    ...
    programs: [
      {
        ...
        description:
          "IEC activities promoting sewerage and water meter connections for clean city initiative",
      ...
      },
      {
        ...
        description:
          "Basic computer and mobile repair skills for livelihood generation",
      ...
      },
      {
        ...
        description:
          "Community campaigns against drug addiction and its social impact",
        beneficiaries: "Community wide",
        outcome: "Community commitment to drug-free lifestyle",
      },
      {
      ...
      },
      {
        name: "Women's Legal Awareness",
        description:
          "Programs on women's rights, dowry prohibition and domestic violence",
        beneficiaries: "Women in rural areas",
      ...
      },
      {
        ...
        description:
          "Rainwater harvesting and water conservation awareness programs",
      ...
      },
      {
        name: "Beauty Parlour Training",
        description:
          "Skill development in beauty services for women's economic independence",
        beneficiaries: 60,
    ...
    programs: [
      {
        ...
        description:
          "Information, Education and Communication activities for sewerage connections in Nagaur and Churu",
      ...
      },
      {
        ...
        description:
          "Advanced design training in Tankla village with RUDA Jaipur designer support",
        beneficiaries: 30,
      ...
      },
      {
        ...
        description:
          "Technical skills training in computer operations and mobile repair",
      ...
      },
      {
        name: "Sewing & Cutting Training",
        description:
          "Tailoring skills for economic empowerment of women and girls",
        beneficiaries: 60,
      ...
      },
      {
        name: "Beauty Parlour Training",
        description:
          "Professional beauty services training with modern techniques",
        beneficiaries: 60,
      ...
      },
      {
        name: "Women's Legal Awareness",
        description:
          "Legal literacy on women's rights and child marriage prevention",
      ...
      },
      {
        ...
        description:
          "Support for artisans and workers with labor diary and scheme awareness",
      ...
      },
      {
        ...
        description:
          "Cleanliness drives and sanitation awareness in villages and cities",
        beneficiaries: "Community wide",
    ...
    programs: [
      {
        ...
        description:
          "Continued vocational tailoring training enabling women-led micro-enterprises (see 2018-19 PDF).",
        beneficiaries: 160,
        outcome:
          "Graduates formed producer/self-help groups increasing household income.",
      },
      {
        name: "Computer & Digital Literacy",
        description:
          "Foundational computer, typing and mobile maintenance workshops for rural youth.",
        beneficiaries: 120,
        outcome:
          "Improved employability and digital service access in target blocks.",
      },
      {
        name: "Women's Legal & Rights Clinics",
        description:
          "Awareness sessions on domestic violence, inheritance and child marriage prevention.",
      ...
      },
      {
        ...
        description:
          "Peer-led motivation and anti‑substance campaigns with family counseling support.",
        beneficiaries: "Community wide",
      ...
      },
      {
        ...
        description:
          "Salon, hygiene and customer service curriculum for livelihood generation.",
        beneficiaries: 55,
    ...
    programs: [
      {
        ...
        description:
          "Business planning, record keeping and market linkage orientation for SHGs.",
        beneficiaries: 70,
      ...
      },
      {
        ...
        description:
          "Traditional craft enhancement with design adaptation and quality control.",
        beneficiaries: 45,
      ...
      },
      {
        ...
        description:
          "IEC modules on anemia prevention, hygiene and menstrual health.",
        beneficiaries: 200,
      ...
      },
      {
        ...
        description:
          "Support kiosk for e-governance form filling and document access.",
      ...
      },
      {
        ...
        description:
          "Value-add finishing techniques (packing, labeling) for apparel trainees.",
        beneficiaries: 90,
    ...
    programs: [
      {
        ...
        description:
          "Emergency distribution of ration kits and hygiene supplies during lockdown phases.",
        beneficiaries: 350,
        outcome:
          "Mitigated immediate food insecurity among vulnerable households.",
      },
      {
        name: "Mask & PPE Stitching Units",
        description:
          "Reoriented tailoring centers to produce reusable masks/PPE for community distribution.",
        beneficiaries: 80,
        outcome:
          "Local protective supplies scaled while preserving trainee livelihoods.",
      },
      {
        name: "Remote Counseling & Helpline",
        description:
          "Phone-based psychosocial and addiction relapse prevention support.",
        beneficiaries: "Helpline callers",
        outcome:
          "Sustained engagement with at‑risk individuals despite mobility curbs.",
      },
      {
        name: "Digital Literacy (Remote Modules)",
        description:
          "Transitioned select computer lessons to low-bandwidth WhatsApp/audio formats.",
        beneficiaries: 60,
    ...
    programs: [
      {
        ...
        description:
          "Post‑lockdown refresher & placement linkage for prior vocational graduates.",
        beneficiaries: 110,
        outcome:
          "Placement/enterprise relaunch for a majority of participants.",
      },
      {
        name: "Women's Safety Legal Desk",
        description:
          "On-site legal advisory & referral desk (domestic violence, property rights).",
        beneficiaries: "Women seekers",
        outcome:
          "Increased formal complaint filings with informed documentation.",
      },
      {
        name: "Water Conservation Micro‑Projects",
        description:
          "Community awareness + demonstration of rooftop rainwater harvesting.",
      ...
      },
      {
        ...
        description:
          "Career pathways, vocational options & soft skills workshops.",
        beneficiaries: 140,
    ...
    programs: [
      {
        ...
        description:
          "Pattern grading, quality checks and small batch production coordination.",
        beneficiaries: 95,
      ...
      },
      {
        ...
        description:
          "Monthly peer learning for women micro-entrepreneurs (pricing, sourcing).",
        beneficiaries: 45,
      ...
      },
      {
        ...
        description:
          "Support center for digital forms, ID updates, scheme awareness.",
    ...
    programs: [
      {
        ...
        description:
          "Coordinated tailoring, beauty, and handicraft cohorts sharing market leads.",
        beneficiaries: 130,
      ...
      },
      {
        ...
        description:
          "Workshops on online fraud prevention, privacy and secure digital identities.",
        beneficiaries: 90,
      ...
      },
      {
        ...
        description:
          "Soil moisture, low-cost recharge pit and kitchen garden demonstrations.",
    ...
    programs: [
      {
        ...
        description:
          "Targeted scaling assistance—brand presentation, packaging and digital cataloging (data interim).",
        beneficiaries: 40,
      ...
      },
      {
        ...
        description:
          "UPI, e-governance, secure document storage and online grievance portals training (interim).",
        beneficiaries: 85,
      ...
      },
      {
        ...
        description:
          "Screening camps & reproductive health counseling (initial rollout).",
        beneficiaries: 120,
      ...
      },
      {
        ...
        description:
          "Short industry visits & guest sessions aligning training with buyer expectations.",
        beneficiaries: 55,
...
export const getTotalPrograms = (): number => {
  return Object.values(progressReportsData).reduce(
    (total, report) => total + report.programs.length,
    0
  );
};
...
export const getTotalBeneficiaries = (): number => {
  return Object.values(progressReportsData).reduce((total, report) => {
    return (
      total +
      report.programs.reduce((programTotal, program) => {
